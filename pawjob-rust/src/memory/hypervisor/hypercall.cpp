...
std::uint64_t hypercall::get_last_invalid_cr3_data(std::uint64_t get_old_cr3)
{
	hypercall_type_t call_type = hypercall_type_t::get_last_invalid_cr3_data;

	return make_hypercall(call_type, 0, get_old_cr3, 0, 0);
}

std::uint64_t hypercall::set_search_for_cr3_data(std::uint64_t target_process_id)
{
	hypercall_type_t call_type = hypercall_type_t::set_search_for_cr3_data;

	return make_hypercall(call_type, 0, target_process_id, 0, 0);
}